    ...
    public struct GroundActions
    {
        ...
        public void SetCallbacks(IGroundActions instance)
        {
            if (m_Wrapper.m_GroundActionsCallbackInterface != null)
            {
                ...
                @Turning.started -= m_Wrapper.m_GroundActionsCallbackInterface.OnTurning;
                @Turning.performed -= m_Wrapper.m_GroundActionsCallbackInterface.OnTurning;
                @Turning.canceled -= m_Wrapper.m_GroundActionsCallbackInterface.OnTurning;
